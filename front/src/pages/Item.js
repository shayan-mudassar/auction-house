...
function Item() {
  ...
  const validationSchema = Yup.object().shape({
    amount: Yup.number("You must input a number.")
      .required("You must input a number to place a bid.")
      .test(
  ...
  const bidOnIt = () => {
    ...
    axios
      .post(`https://localhost:33123/bids/`, holdBidData, head)
      .then((res) => {});
    ...
    axios
      .post(`https://localhost:33123/history/bid/${itemObject.id}`, body2, head)
      .then((reshi) => {});

    // and update the ui
    setItemObject({
      ...itemObject,
      currently: holdBidData.amount,
      number_of_bids: itemObject.number_of_bids + 1,
    });
    handleCloseBid();
  };
  ...
  const onSubmit = (data) => {
    if (itemObject.buy_price && data.amount >= itemObject.buy_price) {
      ...
      Math.floor(Date.parse(itemObject.ends) - Date.parse(today)) <= 0
    ) {
  ...
  const buyIt = () => {
    ...
    if (Math.floor(Date.parse(itemObject.ends) - Date.parse(today)) <= 0) {
      ...
      axios
        .put(
          `https://localhost:33123/items/purchase/${itemObject.id}`,
          body,
          head
        )
        .then((res) => {});
      ...
      axios
        .post(
          `https://localhost:33123/history/bid/${itemObject.id}`,
          body2,
          head
        )
        .then((reshi) => {});
  ...
  const deleteItem = () => {
    ...
    axios
      .delete(`https://localhost:33123/items/${itemObject.id}`, head)
      .then((res) => {});
    navigate(`/`);
  };
  ...
  const switchCategory = () => {
    if (Object.keys(selectedCategory).length > 0) {
      ...
      axios
        .put(
          `https://localhost:33123/items/category/${itemObject.id}`,
          body,
          head
        )
        .then((res) => {});
    ...
    if (locationValue) {
      if (locationValue === itemObject.location) {
        ...
        if (locationValue != null) {
          ...
          axios
            .put(
              `https://localhost:33123/items/location/${itemObject.id}`,
              body,
              head
            )
            .then((res) => {});
  ...
  const switchCoordinates = () => {
    if (Object.keys(coordinatesValue).length > 0) {
      var point = {
        type: "Point",
        coordinates: [coordinatesValue.lat, coordinatesValue.lng],
      };
      ...
      axios
        .put(
          `https://localhost:33123/items/coordinates/${itemObject.id}`,
          body,
          head
        )
        .then((res) => {});
  ...
  const switchName = () => {
    if (nameValue) {
      ...
      axios
        .put(`https://localhost:33123/items/name/${itemObject.id}`, body, head)
        .then((res) => {});
  ...
  const switchDescription = () => {
    if (descriptionValue) {
      ...
      axios
        .put(
          `https://localhost:33123/items/description/${itemObject.id}`,
          body,
          head
        )
        .then((res) => {});
  ...
  const switchCountry = () => {
    if (countryValue) {
      ...
      axios
        .put(
          `https://localhost:33123/items/country/${itemObject.id}`,
          body,
          head
        )
        .then((res) => {});
    ...
    if (startedValue) {
      if (Date.parse(startedValue) - Date.parse(new Date()) <= 0) {
        ...
        if (startedValue != null) {
          ...
          axios
            .put(
              `https://localhost:33123/items/started/${itemObject.id}`,
              body,
              head
            )
            .then((res) => {});
    ...
    if (endsValue) {
      if (Date.parse(endsValue) - Date.parse(new Date()) <= 0) {
        ...
        if (endsValue != null) {
          ...
          axios
            .put(
              `https://localhost:33123/items/ends/${itemObject.id}`,
              body,
              head
            )
            .then((res) => {});
  ...
  const [buyPriceValue, setBuyPriceValue] = React.useState(
  ...
  const switchBuyPrice = () => {
    if (buyPriceValue) {
      if (buyPriceValue <= itemObject.currently) {
        ...
        axios
          .put(
            `https://localhost:33123/items/buyprice/${itemObject.id}`,
            body,
            head
          )
          .then((res) => {});
  ...
  const [currentlyValue, setCurrentlyValue] = React.useState(
    itemObject.currently
  );
    ...
    if (currentlyValue) {
      if (currentlyValue >= itemObject.buy_price) {
        ...
        if (currentlyValue != null) {
          ...
          axios
            .put(
              `https://localhost:33123/items/currently/${itemObject.id}`,
              body,
              head
            )
            .then((res) => {});
  ...
  useEffect(() => {
    ...
    axios.get(`https://localhost:33123/items/fetchy/${id}`).then((res) => {
      ...
      axios
        .get(
          `https://localhost:33123/categories/${res.data.furthermostCategoryId}`
        )
        .then((rescateg) => {
      ...
      if (res.data.UserId) {
        axios
          .get(`https://localhost:33123/auth/fetchy/${res.data.UserId}`)
          .then((respo) => {
      ...
      if (res.data.UserId === authState.id) {
        ...
        if (authState && authState.username !== "admin") {
          ...
          axios
            .post(`https://localhost:33123/history/click/${id}`, body, head)
            .then((respirespi) => {});
        }
      }
    });
    ...
    <>
      <div className="itemPage">
        ...
        <div className="rightSide" id="individual">
              ...
              text={
                ...
                >
                  ...
                  {sellerObject.saleCount ? (
                    <>
                      &nbsp;Seller Rating: {sellerObject.sellerRating} &nbsp;
                      Average: &nbsp;
                      <Rating
                        name="read-only"
                        value={
                          sellerObject.sellerRating / sellerObject.saleCount
                        }
                        readOnly
                        precision={0.5}
                      />
          ...
          {itemObject.buy_price &&
            (authState.status !== true || authState.username === "admin") && (
              <div
                className="footer"
                style={{
                  display: "flex",
          ...
          {!(authState.id === itemObject.UserId) &&
            itemObject.buy_price &&
            authState.status === true &&
            !(authState.username === "admin") &&
            itemObject.state === "AVAILABLE" && (
              <>
                <div className="footer">
                  <div
                    className="footer"
          ...
          {/* } */}
          {itemObject.state === "PURCHASED" && <Header text="Purchased!" />}
          {itemObject.state === "EXPIRED" && <Header text="Auction Expired!" />}

          {/* if there is at least one bid placed display the highest bidder so far */}
          {allBids.length > 0 && (
            <Header
              text={`Highest Bid placed by: ${
                allBids[allBids.length - 1].bidderName
              }`}
            />
          )}
              ...
              <div className="footer" style={{ color: "black" }}>
                <Header
                  text={
                    ...
                    >
                      Currently: {itemObject.currently}$&nbsp;[
                      {itemObject.number_of_bids} bids&nbsp; <GavelIcon />]{" "}
                    </div>
                  }
                />
              </div>
              ...
              <>
                ...
                >
                  <Form className="placeBid">
                    ...
                    />
                    <button className="buttonito" type="submit">
                      Place Bid
                    </button>
                  </Form>
                </Formik>
          ...
          {editMode ? (
            <div>
              {/* To stop editing */}
              {
                <button className="buttonito" onClick={stopEditor}>
                  {" "}
                  Stop Edit{" "}
                </button>
              }
            ...
            <div>
              ...
              {authState.id === itemObject.UserId &&
                (Date.parse(itemObject.started) > Date.parse(today) ||
                  itemObject.number_of_bids === 0) &&
                (itemObject.state === "AVAILABLE" ||
                  itemObject.state === "EXPECTED") && (
                  <div>
                    <button className="buttonito" onClick={editor}>
                      {" "}
                      Edit{" "}
                    </button>
                    <button
              ...
              <Typography
                sx={{ fontFamily: "Futura", width: "100%" }}
                variant="h7"
                component="h2"
              >
              ...
              <Typography
                ...
                component="h2"
              >
                • Trusted sellers, fast shipping, and easy returns{" "}
              </Typography>
              <Typography
                sx={{ fontFamily: "Futura", width: "100%" }}
                variant="h6"
                component="h2"
              >
                • Get the item you ordered or require your money back{" "}
              </Typography>
              <Typography
                sx={{ fontFamily: "Futura", width: "100%" }}
                variant="h6"
                component="h2"
              >
                • Ratings help track the quality provided by the seller{" "}
              </Typography>
              <br />
              <br />
              <div style={{ marginLeft: 216 }}>
              ...
              <Typography
                ...
                component="h2"
              >
                • The payment has to be confirmed within a week{" "}
              </Typography>
              <Typography
                sx={{ fontFamily: "Futura", width: "100%" }}
                variant="h6"
                component="h2"
              >
                • Please allow additional time for international delivery
              </Typography>
              <Typography
                sx={{ fontFamily: "Futura", width: "100%" }}
                variant="h6"
                component="h2"
              >
                • Be aware of shipments from abroad subject to customs
              </Typography>
              <br />
            </div>
          )}
        ...
        >
          <Box sx={style}>
            <div className="headerito">
              <headerito>
                {itemObject.name} Bids <GavelIcon />
              </headerito>
            </div>
        ...
        >
          <Box sx={style2}>
            ...
            <img
              className="purchase_photo"
              src="https://freepikpsd.com/file/2019/10/aplicacion-png-1-Transparent-Images.png"
              alt="product"
            />
            <Typography
              variant="h6"
              ...
              sx={{ mt: 2 }}
            >
              Simply arrange the payment and shipment details within our mail
              app&nbsp;&nbsp;
              <button className="buttonito" onClick={handleClosed}>
                Message the Seller
              </button>
            </Typography>
          </Box>
        ...
        >
          <Box sx={style2}>
            ...
            />
            <button className="buttonito" onClick={switchName}>
              CONFIRM
            </button>
          </Box>
        </Modal>
        ...
        >
          <Box sx={style2}>
            ...
            />
            <button className="buttonito" onClick={switchDescription}>
              CONFIRM
            </button>
          </Box>
        </Modal>
        ...
        >
          <Box sx={style2}>
            ...
            <br />
            <TextField onChange={(e) => handleChangeLocation(e)} />
            <button className="buttonito" onClick={switchLocation}>
              CONFIRM
            </button>
          </Box>
        </Modal>
          ...
          <Box sx={style2}>
            ...
            <div style={{ color: "#00C9FF" }}>
              ...
              {Object.keys(coordinatesValue).length > 0 && (
                <Detail
                  text={`Selected: ${coordinatesValue.lat}, ${coordinatesValue.lng}`}
                />
              )}
            </div>

            <button className="buttonito" onClick={switchCoordinates}>
              CONFIRM
            </button>
          </Box>
        </Modal>
        ...
        >
          <Box sx={style2}>
            ...
            <button className="buttonito" onClick={switchCategory}>
              CONFIRM
            </button>
          </Box>
        </Modal>
        ...
        >
          <Box sx={style2}>
            ...
            <br />
            <Detail
              text={`Current: ${new Date(itemObject.started).toLocaleString()}`}
            />
            <br />
            ...
            <button className="buttonito" onClick={switchStarted}>
              CONFIRM
            </button>
          </Box>
        </Modal>
        ...
        >
          <Box sx={style2}>
            ...
            <br />
            <Detail
              text={`Current: ${new Date(itemObject.ends).toLocaleString()}`}
            />
            <br />
            <LocalizationProvider dateAdapter={AdapterDayjs}>
              <DateTimePicker
            ...
            <button className="buttonito" onClick={switchEnds}>
              CONFIRM
            </button>
          </Box>
        </Modal>
        ...
        >
          <Box sx={style2}>
            ...
            <button className="buttonitoReverse" onClick={handleClosePurchase}>
              Cancel
            </button>
            <button className="buttonito" onClick={buyIt} autoFocus>
              Confirm
            </button>
          </Box>
        </Modal>
        ...
        >
          <Box sx={style2}>
            ...
            <HeaderNormal text="You can't reverse this action" />
            <button className="buttonitoReverse" onClick={handleCloseBid}>
              Cancel
            </button>
            <button className="buttonito" onClick={bidOnIt} autoFocus>
              Confirm
            </button>
          </Box>
        </Modal>
        ...
        >
          <Box sx={style2}>
            ...
            <HeaderNormal text="You can't reverse this action" />
            <button className="buttonitoReverse" onClick={handleCloseDelete}>
              Cancel
            </button>
            <button className="buttonito" onClick={deleteItem} autoFocus>
              Confirm
            </button>
          </Box>
        </Modal>
        ...
        >
          <Box sx={style2}>
            ...
            />
            <button className="buttonito" onClick={switchBuyPrice}>
              CONFIRM
            </button>
          </Box>
        </Modal>
        ...
        >
          <Box sx={style2}>
            ...
            />
            <button className="buttonito" onClick={switchCurrently}>
              CONFIRM
            </button>
          </Box>
        </Modal>
        ...
        >
          <Box sx={style2}>
            ...
            />
            <button className="buttonito" onClick={switchCountry}>
              CONFIRM
            </button>
          </Box>
        </Modal>
