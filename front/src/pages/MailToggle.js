    ...
    <>
      ...
      <div className="container" style={{ backgroundColor: "white" }}>
        <ToggleButtonGroup
          ...
          aria-label="Platform"
        >
          <ToggleButton value="message" sx={{ fontFamily: "Futura" }}>
            <MailOutlineIcon />
            &nbsp;NEW MESSAGE
          </ToggleButton>
          <ToggleButton value="inbox" sx={{ fontFamily: "Futura" }}>
            <InboxIcon />
            &nbsp;INBOX
          </ToggleButton>
          <ToggleButton value="outbox" sx={{ fontFamily: "Futura" }}>
            <OutboxIcon />
            &nbsp;OUTBOX
          </ToggleButton>
          <ToggleButton value="chats" sx={{ fontFamily: "Futura" }}>
            <QuestionAnswerIcon />
            &nbsp;SALES
          </ToggleButton>
          <ToggleButton value="reviews" sx={{ fontFamily: "Futura" }}>
            <ReviewsIcon />
            &nbsp;PURCHASES
          </ToggleButton>
        </ToggleButtonGroup>
