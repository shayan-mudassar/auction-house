...
function Registration() {
  ...
  const validationSchema = Yup.object().shape({
    ...
    taxnumber: Yup.number()
      .required("You must input your tax number.")
      .positive()
      .integer()
      .lessThan(1000000000, "This is not valid")
      .moreThan(99999999, "This is not valid"),
  });
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            ...
            {Object.keys(coordinates).length > 0 && (
              ...
              >
                Set to:&nbsp;&nbsp;
                {ConvertDMS(coordinates.lat, coordinates.lng)}
              </Typography>
            )}
          </DialogContentText>
        </DialogContent>
      ...
      >
        <Box sx={style}>
          ...
          <Typography variant="h6" id="modal-modal-description" sx={{ mt: 2 }}>
            You'll be able to use our services as soon as you have been
            approved!
          </Typography>
        </Box>
      </Modal>
