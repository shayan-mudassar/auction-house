...
export default function ConfirmArrival(props) {
  ...
  const handleConfirm = () => {
    ...
    axios
      .post(
        `https://localhost:33123/mail/confirmarrival/${props.mail.id}`,
        body,
        head
      )
      .then((res) => {});
  ...
  return (
    <div>
      <button className="buttonitoMail" onClick={handleClickOpen}>
        {" "}
        Confirm Arrival
      </button>
      <Dialog
      ...
      >
        ...
        <DialogActions>
          ...
          <button className="buttonito" onClick={handleConfirm} autoFocus>
            Confirm
          </button>
        </DialogActions>
      </Dialog>
      ...
      >
        <Box sx={style}>
          ...
          <img
            ...
            src="https://cdni.iconscout.com/illustration/premium/thumb/candidate-rating-and-review-2537380-2146476.png"
          />

          <Typography variant="h6" id="modal-modal-description" sx={{ mt: 2 }}>
            Aside from rating you can also give further feedback directly to the
            seller! Your opinion is important!
          </Typography>
