...
export default function MailChats() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://localhost:33123/mail/seller/${authState.id}`, head)
      .then((res) => {
  ...
  const displayChat = (name) => {
    ...
    axios
      .get(`https://localhost:33123/mail/seller/chat/${authState.id}`, head)
      .then((res) => {
